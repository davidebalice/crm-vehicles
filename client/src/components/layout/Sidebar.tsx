...
const NavItem: FC<NavItemProps> = ({ href, icon, children, currentPath }) => {
  ...
  return (
    <Link href={href}>
      <div
        className={`flex items-center px-4 py-3 text-white hover:bg-primary-light ${
...
const NavExternalItem: FC<NavExternalItemProps> = ({
  href,
  icon,
  children,
}) => {
...
const NavGroup: FC<NavGroupProps> = ({ title, children }) => {
  return (
    <div className="py-2">
      <div className="px-4 py-2 text-sm text-neutral-300 uppercase tracking-wider">
        {title}
      </div>
      {children}
    </div>
  ...
  return (
    <aside className="hidden md:flex flex-col w-64 bg-primary text-white overflow-y-auto scrollbar-hide">
      <div className="p-4 flex items-center justify-between border-b border-primary-light">
        <div className="font-montserrat font-bold text-xl">Gestionale auto</div>
        <button
          onClick={toggleTheme}
      ...
      <div className="flex-1">
        <nav className="mt-4">
          ...
          <NavGroup title="Veicoli">
            ...
            <NavItem
              href="/vehicles/catalog-settings"
          ...
          <NavGroup title="Finanza">
            ...
            <NavItem
              href="/finance/scheduled-transactions"
